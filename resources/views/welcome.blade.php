...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0"> {{-- min-h-screen--}}
            @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    {{-- {{ HTML::image('img/Logo-kontakt2020.png', 'alt text', array('class' => 'css-class')) }} --}}
                    {{-- {{ HTML::image('img/Logo-kontakt2020.png', 'Logo Kontakt 2020') }} --}}
                    <img src="img/Logo-big-flat-Kontakt2020.png" alt="Logo Kontakt 2020">  
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Kontakt2020</div>
                            </div>
